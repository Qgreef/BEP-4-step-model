...
r16n = Road(G, "n", "o", 1.75, 1800)
r16o = Road(G, "o", "n", 1.75, 1800)
r17o = Road(G, "o", "j", 1.5, 1800)
r17j = Road(G, "j", "o", 1.5, 1800)
...
r21z = Road(G, "z", "r", 4.75, 1800)
r21r = Road(G, "r", "z", 4.75, 1800)
r22gg = Road(G, "gg", "ff", 2, 1800)
r22ff = Road(G, "ff", "gg", 2, 1800)
r23ff = Road(G, "ff", "Z", 1.5, 1800)
r23Z = Road(G, "Z", "ff", 1.5, 1800)
r24Z = Road(G, "Z", "b", 2.75, 1800)
r24b = Road(G, "b", "Z", 2.75, 1800)
r25b = Road(G, "b", "e", 2.75, 1800)
r25e = Road(G, "e", "b", 2.75, 1800)
r26e = Road(G, "e", "f", 0.25, 3600)
r26f = Road(G, "f", "e", 0.25, 3600)
r27f = Road(G, "f", "i", 0.75, 3600)
r27i = Road(G, "i", "f", 0.75, 3600)
r28i = Road(G, "i", "m", 1.5, 3600)
r28m = Road(G, "m", "i", 1.5, 3600)
r29m = Road(G, "m", "n", 1.75, 3600)
r29n = Road(G, "n", "m", 1.75, 3600)
r30n = Road(G, "n", "NW", 1.25, 3600)
r30NW = Road(G, "NW", "n", 1.25, 3600)
r31NW = Road(G, "NW", "r", 1, 3600)
r31r = Road(G, "r", "NW", 1, 3600)
r32r = Road(G, "r", "s", 2.5, 3600)
r32s = Road(G, "s", "r", 2.5, 3600)
r33s = Road(G, "s", "N", 1.25, 3600)
r33N = Road(G, "N", "s", 1.25, 3600)
r34N = Road(G, "N", "v", 3, 3600)
r34v = Road(G, "v", "N", 3, 3600)
r35v = Road(G, "v", "N6", 1, 1800)
r35N6 = Road(G, "N6", "v", 1, 1800)
r36v = Road(G, "v", "x", 0.75, 3600)
r36x = Road(G, "x", "v", 0.75, 3600)
r37v = Road(G, "v", "w", 0.5, 1800)
r37w = Road(G, "w", "v", 0.5, 1800)
r38w = Road(G, "w", "x", 0.75, 1800)
r38x = Road(G, "x", "w", 0.75, 1800)
r39w = Road(G, "w", "bb", 4.5, 1800)
r39bb = Road(G, "bb", "w", 4.5, 1800)
r40bb = Road(G, "bb", "O", 3, 1800)
r40O = Road(G, "O", "bb", 3, 1800)
r41O = Road(G, "O", "gg", 2.75, 1800)
r41gg = Road(G, "gg", "O", 2.75, 1800)
r42O = Road(G, "O", "aa", 1.75, 1800)
r42aa = Road(G, "aa", "O", 1.75, 1800)
r43O = Road(G, "O", "cc", 0.75, 1800)
r43cc = Road(G, "cc", "O", 0.75, 1800)
r44cc = Road(G, "cc", "ff", 4.0, 1800)
r44ff = Road(G, "cc", "ff", 4.0, 1800)
r45cc = Road(G, "cc", "aa", 1.75, 1800)
r45aa = Road(G, "aa", "cc", 1.75, 1800)
r46aa = Road(G, "aa", "y", 1.75, 1800)
r46y = Road(G, "y", "aa", 1.75, 1800)
r47y = Road(G, "y", "x", 1, 3600)
r47x = Road(G, "x", "y", 1, 3600)
r48y = Road(G, "y", "C", 1.25, 3600)
r48C = Road(G, "C", "y", 1.25, 3600)
r49aa = Road(G, "aa", "q", 1.25, 1800)
r49q = Road(G, "q", "aa", 1.25, 1800)
r50d = Road(G, "d", "cc", 1.5, 1800)
r50cc = Road(G, "cc", "d", 1.5, 1800)
r51z = Road(G, "z", "C", 0.75, 3600)
r51C = Road(G, "C", "z", 0.75, 3600)
...
r56d = Road(G, "d", "p", 1.75, 1800)
r56p = Road(G, "p", "d", 1.75, 1800)
r57p = Road(G, "p", "f", 1.5, 1800)
r57f = Road(G, "f", "p", 1.5, 1800)
r58p = Road(G, "p", "j", 2.25, 1800)
r58j = Road(G, "j", "p", 2.25, 1800)
